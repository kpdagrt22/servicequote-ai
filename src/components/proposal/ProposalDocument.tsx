...
import type { ProposalView } from "@/lib/quotes/proposal";

/**
 * Presentational, print-friendly proposal document. Shared by the contractor's
 * print page (/proposal/[id]/print) and the customer's public page (/p/[token])
 * so the two never drift. Pure — takes a fully-built ProposalView.
 */
